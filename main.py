...
def main():
    ...
    split_grand_tot = split_total + ny_tax / split_number
    rounding()
    print("Calculating your total...")
    print("---------------------------------------- \n Here is your bill summary:")
    print("Subtotal: $", subtotal)
    print("NYC Tax (8.875%): $", math.ceil(ny_tax))
    print("Tip (", tip_value, "): $", math.ceil(tip))
    print("Grand Total: $", math.ceil(bill_subtotal + total_tip + ny_tax))
    print("You will be splitting your bill amongst", math.ceil(split_number), "person/people.")
    print("Your total for each person will be (with tips): $", math.ceil(split_grand_tot + tip / split_number))
    print("Your total for each person will be (without tips): $", math.ceil(split_grand_tot))
